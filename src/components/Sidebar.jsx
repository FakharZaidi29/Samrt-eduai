  ...
  return (
    <button
      ...
      className={`
        ...
        ${isActive
          ? 'bg-red-600 text-white shadow-sm shadow-red-200/60 dark:shadow-red-900/40'
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-zinc-900 border-r border-slate-200 dark:border-zinc-800">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-100 dark:border-zinc-800">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-red-600 to-red-800 flex items-center justify-center shadow-sm shadow-red-200 dark:shadow-red-900">
      ...
      <div className="px-3 pt-3 pb-4 border-t border-slate-100 dark:border-zinc-800 space-y-1">
        ...
        >
          ...
          <div className={`w-9 h-5 rounded-full transition-colors duration-300 flex items-center px-0.5 flex-shrink-0 ${darkMode ? 'bg-red-600' : 'bg-slate-200 dark:bg-zinc-700'}`}>
